...
def mat_dictionary():
    mylist=[(1,'NUT PLATE  XA 67008',0.035,0,0), (2,'LATCH  SL 70503',0.021,0,0), (3,'SPRING HOLDER  SL 70504',0.013,0,0), (4,'SPACER STRIP  SL 70516',0.035,0,0), (5,'SPACER STRIP  SL 70518',0.065,0,0), (6,'STOP  SL 70535',0.036,0,0), (7,'BRACKET  SL 70651 V',0.05,0,0), (8,'LATCH  SL 70655',0.024,0,0), (9,'CONN PIECE  SL 70699 V',0.017,0,0), (10,'CONN STRIPS  SL 70702',0.035,0,0), (11,'STRIP  SL 70734',0.006,0,0), (12,'DIRECT CONN PC  SL 70735',0.012,0,0), (13,'CONN PIECE   SL 70736',0.017,0,0), (14,'LOCK  SL 70748',0.005,0,0), (15,'STRIP  SL 70768',0.0044,0,0), (16,'SUPPORT  SL 70769',0.057,0,0), (17,'STRIP  SL 70875 T',0.007,0,0), (18,'COVER  SL 70877',0.24,0,0), (19,'CONN PIECE  SL 70919',0.0237,0,0), (20,'SUPPORT  SL 70975',0.18,0,0), (21,'MTG PLATE  SL 71150',0.095,0,0), (22,'LEVER  SL 71162',0.09,0,0),(23,'BRACKET  SL 71167',0.058,0,0), (24,'STOP  SL 71193',0.02,0,0), (25,'BRACKET  SL 71204',0.087,0,0), (26,'LOCK PLATE  SL 71452',0.058,0,0), (27,'LEVER ASSLY  SL 90024',0.098,0,0), (28,'LATCH ASSLY  ST 31641',0.042,0,0), (29,'LEFT LATCH  SL 90632 T',0.021,0,0), (30,'RIGHT LATCH  SL 90633 T',0.021,0,0), (31,'BRACKET  SL70198',0.122,0,0)]
    list1 = []
    list2 = []
    for i in mylist:
        list1.append(i[1])
...
# Creating dropbox
material_name_list= ['NUT PLATE  XA 67008', 'LATCH  SL 70503', 'SPRING HOLDER  SL 70504', 'SPACER STRIP  SL 70516', 'SPACER STRIP  SL 70518', 'STOP  SL 70535', 'BRACKET  SL 70651 V', 'LATCH  SL 70655', 'CONN PIECE  SL 70699 V', 'CONN STRIPS  SL 70702', 'STRIP  SL 70734', 'DIRECT CONN PC  SL 70735', 'CONN PIECE   SL 70736', 'LOCK  SL 70748', 'STRIP  SL 70768', 'SUPPORT  SL 70769', 'STRIP  SL 70875 T', 'COVER  SL 70877', 'CONN PIECE  SL 70919', 'SUPPORT  SL 70975', 'MTG PLATE  SL 71150', 'LEVER  SL 71162', 'BRACKET  SL 71167', 'STOP  SL 71193', 'BRACKET  SL 71204', 'LOCK PLATE  SL 71452', 'LEVER ASSLY  SL 90024', 'LATCH ASSLY  ST 31641', 'LEFT LATCH  SL 90632 T', 'RIGHT LATCH  SL 90633 T', 'BRACKET  SL70198']
clicked = StringVar()
